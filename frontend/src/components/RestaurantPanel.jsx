              ...
              <div style={{ background: verdictInfo.bg, borderRadius: 12, padding: "14px 16px" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: 12, color: verdictInfo.color }}>
                    ...
                    {adResult.cached && <span style={{ fontSize: 10, color: "#aaa", marginLeft: 6 }}>({adResult.checked_at} 기준)</span>}
                  </span>
                </div>
            ...
            {r.sources.map((s, i) => {
              ...
              return (
                <a key={i} href={s.post_url} target="_blank" rel="noreferrer" style={{
                  ...
                  background: "#fafafa", borderRadius: 10, textDecoration: "none", border: "1px solid #f0f0f0",
                }}>
                  <div style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: "#1a1a1a" }}>{s.author_name || s.author_id}</p>
                    <p style={{ margin: 0, fontSize: 11, color: "#888", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.post_title}</p>
                  </div>
